...
class UserAgentInfo:
    ...
    def get_browser_family(self) -> str:
        ...
        return self._obj.browser.family or "Unknown"
    ...
    def get_browser_family_major(self) -> str:
        ...
        """
        browser_family = self._obj.browser.family or "Unknown"
        browser_version_info = self.get_browser_version_info()
        browser_major = browser_version_info.get("major", "Unknown")
        return f"{browser_family}|{browser_major}"
    ...
    def get_os_family_major(self) -> str:
        ...
        """
        os_family = self._obj.os.family or "Unknown"
        os_version_info = self.get_operating_system_version_info()
        os_major = os_version_info.get("major", "Unknown")
        return f"{os_family}|{os_major}"
