...
class AuthContext(Base):
    ...
    client = Column(
        String(32), nullable=False, doc="The client application name or identifier."
    )
    ip_address = Column(
        String(32), nullable=False, doc="IP address from which the request originated."
    )
    system_language = Column(
        String(32), nullable=False, doc="Language setting on the system."
    )
    ...
    operating_system = Column(String(32), doc="Operating system information.")
    browser = Column(String(32), doc="Browser information.")
